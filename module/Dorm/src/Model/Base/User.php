...
abstract class User implements ActiveRecordInterface
{
    ...
    public function setStreet($v)
    {
        ...
        if ($this->street !== $v) {
            $this->street = $v;
            $this->modifiedColumns[UserTableMap::COL_STREET] = true;
        }
    ...
    public function setZip($v)
    {
        ...
        if ($this->zip !== $v) {
            $this->zip = $v;
            $this->modifiedColumns[UserTableMap::COL_ZIP] = true;
        }
    ...
    public function setDob($v)
    {
        ...
        if ($this->dob !== null || $dt !== null) {
            if ($this->dob === null || $dt === null || $dt->format("Y-m-d") !== $this->dob->format("Y-m-d")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_DOB] = true;
            }
    ...
    public function setStudentId($v)
    {
        ...
        if ($this->student_id !== $v) {
            $this->student_id = $v;
            $this->modifiedColumns[UserTableMap::COL_STUDENT_ID] = true;
        }
    ...
    public function setUnitId($v)
    {
        ...
        if ($this->unit_id !== $v) {
            $this->unit_id = $v;
            $this->modifiedColumns[UserTableMap::COL_UNIT_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('Street', TableMap::TYPE_PHPNAME, $indexType)];
            $this->street = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UserTableMap::translateFieldName('City', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('Zip', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : UserTableMap::translateFieldName('Dob', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->dob = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : UserTableMap::translateFieldName('StudentId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->student_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : UserTableMap::translateFieldName('UnitId', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_STREET)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ZIP)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_DOB)) {
            $modifiedColumns[':p' . $index++]  = 'dob';
        }
        if ($this->isColumnModified(UserTableMap::COL_STUDENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'student_id';
        }
        if ($this->isColumnModified(UserTableMap::COL_UNIT_ID)) {
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[9] => $this->getDob(),
            $keys[10] => $this->getStudentId(),
            $keys[11] => $this->getUnitId(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[10], $arr)) {
            $this->setStudentId($arr[$keys[10]]);
        }
        if (array_key_exists($keys[11], $arr)) {
            $this->setUnitId($arr[$keys[11]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_STREET)) {
            $criteria->add(UserTableMap::COL_STREET, $this->street);
        }
        if ($this->isColumnModified(UserTableMap::COL_CITY)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_ZIP)) {
            $criteria->add(UserTableMap::COL_ZIP, $this->zip);
        }
        if ($this->isColumnModified(UserTableMap::COL_PHONE)) {
        ...
        if ($this->isColumnModified(UserTableMap::COL_DOB)) {
            $criteria->add(UserTableMap::COL_DOB, $this->dob);
        }
        if ($this->isColumnModified(UserTableMap::COL_STUDENT_ID)) {
            $criteria->add(UserTableMap::COL_STUDENT_ID, $this->student_id);
        }
        if ($this->isColumnModified(UserTableMap::COL_UNIT_ID)) {
            $criteria->add(UserTableMap::COL_UNIT_ID, $this->unit_id);
        }
