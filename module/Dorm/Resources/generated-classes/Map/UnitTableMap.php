...
class UnitTableMap extends TableMap
{
     ...
     */
    const COL_BUILDING_NUMBER = 'unit.building_number';

    /**
     * the column name for the floor_number field
     */
    const COL_FLOOR_NUMBER = 'unit.floor_number';

    /**
     * the column name for the room_number field
     */
    const COL_ROOM_NUMBER = 'unit.room_number';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'BuildingNumber', 'FloorNumber', 'RoomNumber', ),
        self::TYPE_CAMELNAME     => array('id', 'buildingNumber', 'floorNumber', 'roomNumber', ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_ID, UnitTableMap::COL_BUILDING_NUMBER, UnitTableMap::COL_FLOOR_NUMBER, UnitTableMap::COL_ROOM_NUMBER, ),
        self::TYPE_FIELDNAME     => array('id', 'building_number', 'floor_number', 'room_number', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'BuildingNumber' => 1, 'FloorNumber' => 2, 'RoomNumber' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'buildingNumber' => 1, 'floorNumber' => 2, 'roomNumber' => 3, ),
        self::TYPE_COLNAME       => array(UnitTableMap::COL_ID => 0, UnitTableMap::COL_BUILDING_NUMBER => 1, UnitTableMap::COL_FLOOR_NUMBER => 2, UnitTableMap::COL_ROOM_NUMBER => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'building_number' => 1, 'floor_number' => 2, 'room_number' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('building_number', 'BuildingNumber', 'INTEGER', true, null, null);
        $this->addColumn('floor_number', 'FloorNumber', 'INTEGER', true, null, null);
        $this->addColumn('room_number', 'RoomNumber', 'INTEGER', true, null, null);
    } // initialize()
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UnitTableMap::COL_BUILDING_NUMBER);
            $criteria->addSelectColumn(UnitTableMap::COL_FLOOR_NUMBER);
            $criteria->addSelectColumn(UnitTableMap::COL_ROOM_NUMBER);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.building_number');
            $criteria->addSelectColumn($alias . '.floor_number');
